...
JSON.stringify (
    ...
    },
    {
        ...
        },
        {
            ...
            genre:"Isekai",
            about: "The Beginning After The End (Korean: 끝이 아닌 시작, Japanese: 最強の王様、二度目の人生は何を？, Mandarin 三岁开始做王者) is a Tapas Original seasonal comic, based on the novel of the same name, is rtten by TurtleMe and illustrated by Fuyuki23. The release schedule is 3 times a month for Season  and eekly for Season 2 and Season 3. It's currently available in English, Korean, Japanese, Thai, Chinese Mandarin and French.",
            amount: 280,
            quantity: 1,
